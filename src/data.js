...
export const writingText = `This is my first experience with writing. I will try to share with you things about programming and technologies. I will cover topics that I love, that concern me, and that I find interesting.`;
...
export const selectedProjects = [
  { name: 'Next JS website for my client', link: 'https://www.gardensano.cz' },
  { name: 'E-commerce Next JS/Headles CMS in progress', link: 'https://oziashop.netlify.app' },
  { name: 'Project 3', link: '#' },
  { name: 'Project 4', link: '#' },
];
